		...
		if(!Config.ENCHANT_HERO_WEAPON && item.getItemId() >= 6611 && item.getItemId() <= 6621)
		{
			...
			return;
		        ...
		        if(activeChar.isInCraftMode())
			        {
			             activeChar.setActiveEnchantItem(null);
			             activeChar.sendMessage("Proibido Enchantar quando estiver Crafitando");
			             return;
			        }
			        if(activeChar.isTeleporting())
			            {
			            activeChar.setActiveEnchantItem(null);
			            activeChar.sendMessage("Proibido Enchantar quando estiver Teleportando");
			            return;
			            }
			        if(activeChar.isDead())
			            {
			            activeChar.setActiveEnchantItem(null);
			            activeChar.sendMessage("Proibido Enchantar quando estiver Morto");
			            return;
			            }
			        if(activeChar.isSleeping())
			            {
			            activeChar.setActiveEnchantItem(null);
			            activeChar.sendMessage("Proibido Enchantar quando estiver sobre Efeito Sleep");
			            return;
			            }
			        if(activeChar.isParalyzed())
			            {
			            activeChar.setActiveEnchantItem(null);
			            activeChar.sendMessage("Proibido Enchantar quando estiver sobre Efeito Paralize");
			            return;
			            }
			        ...
			        if(activeChar.isCastingNow())
			            {
			            activeChar.setActiveEnchantItem(null);
			            activeChar.sendMessage("Proibido Enchantar quando estiver Conjurando");
			            return;
			            }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver em Movimento");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver em Trade");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver sobre Efeito Stun");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver em Montaria");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver em Modo Fake Death");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver na Jaula");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver no Modo Cursed Weapon");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver na Agua");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver Voando");
			        return;
			        }
			        ...
			        {
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver Pescando");
			        return;
			        }
			        ...
			        { 
			        activeChar.setActiveEnchantItem(null);
			        activeChar.sendMessage("Proibido Enchantar quando estiver Sentado"); 
			        return; 
			        } 
