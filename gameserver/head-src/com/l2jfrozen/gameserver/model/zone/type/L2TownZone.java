	...
	protected void onExit(L2Character character)
	{
		...
		if(character instanceof L2PcInstance)
			...
			{
			{
				...
				((L2PcInstance) character).sendMessage("AIOx nao pode sair de " + _townName + ". Voce foi teleportado para a vila mais proxima.");
			}
		
	}
			  else

				((L2PcInstance) character).sendMessage("Voce deixou " + _townName + ".");}
				  }
