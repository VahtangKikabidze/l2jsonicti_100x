	...
	public boolean doDie(L2Character killer)
	{
		...
		if(player != null)
		{
			 if (getNpcId() == Config.IdBoss)
				 ...
				 Announcements.getInstance().gameAnnounceToAll("O Boss foi Derrotado! Parabens "+player);
				 }
			...
			if(player.getParty() != null)
			{
				 if (getNpcId() == Config.IdBoss)
					 ...
					 com.l2jfrozen.gameserver.model.entity.event.BossEvent.unspawnEventBoss2();
					 Announcements.getInstance().gameAnnounceToAll("O Boss foi morto Parabens "+player);
					 }
