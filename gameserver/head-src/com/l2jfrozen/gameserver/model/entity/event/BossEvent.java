...
public class BossEvent
{
 ...
 {
 spawnMonsterloc1();
 Announcements.getInstance().gameAnnounceToAll("Lost Boss Event! Procure e Mate o Boss Perdido!");
 ...
 Announcements.getInstance().gameAnnounceToAll("Voce tem "+Config.time_unrespawn+" Minutos para Achar e Matar o Boss Perdido!");
 try
 {
 ...
 Announcements.getInstance().gameAnnounceToAll("Fim de Evento! O Boss foi Derrotado!");
 unspawnEventBoss();
 }
 ...
 {
 System.out.println("Erro no evento Treasure");
 }
 }
 ...
 {
 System.out.println("Erro no evento Lost boss");
 }
 }
