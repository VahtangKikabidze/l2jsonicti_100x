...
public abstract class L2Character extends L2Object
{
	...
	/* (non-Javadoc)
	 * @see com.l2jfrozen.gameserver.model.L2Object#onSpawn()
	 */
	@Override
	public void onSpawn()
	{
...
*/
	...
	public void doCast(L2Skill skill)
	{
		...
		*/
		...
		if(hitTime > 210)
		{
			...
			if(!skill.isPotion()){ //for particular potion is the timestamp to disable particular skill
	...
	/* (non-Javadoc)
	 * @see com.l2jfrozen.gameserver.model.L2Object#getKnownList()
	 */
	@Override
			...
			for(int i = 0; i < effects.length; i++)
			{
						...
						&& effects[i].getStackType() == newEffect.getStackType())
				{
					if((newEffect.getSkill().getSkillType() == L2Skill.SkillType.BUFF 
							...
							&& newEffect.getStackOrder() >= effects[i].getStackOrder())
					{
	...
	public static final int ZONE_NOSTORE = 16384;
	static
	{
...
//					removeStatFuncs(skill_funcs);
	...
	public boolean doesStack(L2Skill checkSkill)
	{
		...
		for(L2Effect e : effects)
		{
			...
			if(e.getStackType() != null &&
					e.getStackType().equals(stackType))
				return true;
		}
	...
	/* (non-Javadoc)
	 * @see com.l2jfrozen.gameserver.model.L2Object#toString()
	 */
	@Override
