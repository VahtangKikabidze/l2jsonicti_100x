...
print "importing custom: 9998: PetBuffer"
...
class Quest (JQuest) :
	...
	def onEvent(self,event,st):
		...
		if count < 100 or st.getPlayer().getLevel() < 1 :
			htmltext = "<html><head><body>You Need more adenas<br></body></html>"
		elif count < 100 or st.getPlayer().getPet() < 1 :
			htmltext = "<html><head><body>You Need Pet or Summon<br></body></html>"
			st.exitQuest(1)
		else:
			...
			if event == "2":
				...
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4346,4).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4349,2).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				...
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4348,6).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4352,2).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				...
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4360,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4358,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4357,2).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4359,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				...
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4700,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4703,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
			...
			if event == "3": 
				st.takeItems(ADENA_ID,0)
				st.getPlayer().getPet(),st.getPlayer().getPet().stopAllEffects()
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4344,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4346,4).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				...
				SkillTable.getInstance().getInfo(4349,2).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4353,6).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(1389,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4347,6).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				...
				SkillTable.getInstance().getInfo(4348,6).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4355,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4356,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4352,2).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(1303,1).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(1087,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(1397,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4351,6).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				...
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4699,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4702,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4703,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(1323,1).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
			...
			if event == "4":
				st.takeItems(ADENA_ID,0)
				sst.getPlayer().getPet(),st.getPlayer().getPet().stopAllEffects()
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4344,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				st.getPlayer().restoreHPMP()
				SkillTable.getInstance().getInfo(4346,4).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
			...
			if event == "8":
				st.takeItems(ADENA_ID,0)
				SkillTable.getInstance().getInfo(4343,3).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				return "5.htm"		
				st.setState(COMPLETED)
			...
			if event == "15":
				st.takeItems(ADENA_ID,0)
				SkillTable.getInstance().getInfo(4350,4).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				return "5.htm"		
				st.setState(COMPLETED)
			...
			if event == "37":
				st.takeItems(ADENA_ID,0)
				SkillTable.getInstance().getInfo(366,1).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				return "2.htm"
			...
			if event == "73":
				st.takeItems(ADENA_ID,0)
				st.getPlayer().getPet(),st.getPlayer().getPet().useMagic(SkillTable.getInstance().getInfo(1352,1),False,False)
				return "5.htm"
				st.setState(COMPLETED)	
			...
			if event == "74":
				st.takeItems(ADENA_ID,0)
				st.getPlayer().getPet(),st.getPlayer().getPet().useMagic(SkillTable.getInstance().getInfo(1353,1),False,False)
				return "5.htm"
				st.setState(COMPLETED)	
			...
			if event == "75":
				st.takeItems(ADENA_ID,0)
				st.getPlayer().getPet(),st.getPlayer().getPet().useMagic(SkillTable.getInstance().getInfo(1354,1),False,False)
				return "5.htm"
				st.setState(COMPLETED)	
			...
			if event == "80":
				st.takeItems(ADENA_ID,0)
				SkillTable.getInstance().getInfo(1073,1).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				return "5.htm"
				st.setState(COMPLETED)	
			...
			if event == "83":
				st.takeItems(ADENA_ID,0)
				SkillTable.getInstance().getInfo(1311,6).getEffects(st.getPlayer().getPet(),st.getPlayer().getPet())
				return "5.htm"
				st.setState(COMPLETED)	
	...
	def onTalk (self,npc,player):#verifica player se tem PET/Flag/Karma ou modo de combate.
		htmltext = "<html><head><body>Voce nao pode buffar estando em</body></html>"
		st = player.getQuestState(qn)
		if not st : return htmltext
		npcId = npc.getNpcId()
		if player.getPet() == None :#Player sem Pet
			htmltext = "<html><head><body>Voce precisa de um pet ou summon</body></html>"
			st.exitQuest(1)
		elif st.player.getPvpFlag() > 0 :#Player Flag
			htmltext = "<html><head><body>Voce nao pode buffar estando em <font color=\"800080\">Flag!</font><br>Wait some time and try again!</body></html>"
			st.exitQuest(1)
		elif st.player.getKarma() > 0 :#Player com Karma
			st.exitQuest(1)
			htmltext = "<html><head><body>Voce possui muito <font color=\"FF0000\">karma!</font><br>volte,<br>quando nao possuir mais karma!</body></html>"
		elif st.player.isInCombat() :#Player modo de Combate
			st.exitQuest(1)
			htmltext = "<html><head><body>Voce nao pode Buffar em modo de Ataque!<br>Aguarde e tente novamente!</body></html>"
		else:
